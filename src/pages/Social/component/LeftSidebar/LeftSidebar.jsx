  ...
  return (
    ...
    <div className='left-sidebar-scrollable'>
      <nav className='left-sidebar-nav'>
        ...
        >
          <span className='sidebar-icon icon-wallet'>
            <svg
              viewBox='0 0 24 24'
              fill='none'
              xmlns='http://www.w3.org/2000/svg'
        ...
        >
          <span className='sidebar-icon icon-chat'>
            <svg
              viewBox='0 0 24 24'
              fill='none'
              xmlns='http://www.w3.org/2000/svg'
        ...
        <button className='sidebar-item'>
          <span className='sidebar-icon icon-bookmark'>
            <svg
              viewBox='0 0 24 24'
              fill='none'
              xmlns='http://www.w3.org/2000/svg'
        ...
        >
          <span className='sidebar-icon icon-settings'>
            <svg
              viewBox='0 0 24 24'
              fill='none'
              xmlns='http://www.w3.org/2000/svg'
